...
class VehicleConverterSpec extends Specification {
  ...
  def "test convert sensor records to vehicles"() {
    ...
    def record5 = new SensorRecord(sensorType, LocalTime.of(20, 21))
    def record6 = new SensorRecord(sensorType, LocalTime.of(10, 11))
    ...
    dailyRecords.addRecord(record5)
    dailyRecords.addRecord(record6)
